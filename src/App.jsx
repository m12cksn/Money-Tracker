...
function App() {
  const dataTransaction = [
    { desc: "Salary", amount: "200000", status: "income", date: "2024-03-12" },
    { desc: "Haircut", amount: "20000", status: "expense", date: "2024-03-15" },
  ];
  ...
  return (
    ...
    //     <div className="bg-white h-96 mx-auto px-5 rounded-t-3xl">
    //       <div>
    //         <form action="">
    //           <div></div>
    //         </form>
    //       </div>
    //       <h1 className="pt-5 text-xl font-semibold">Transaction</h1>
